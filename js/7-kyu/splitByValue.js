...
// MyAnswer
function splitByValue(k, array){
  var smallerValues = array.filter(function(element){
    return element <= k;
  });
  var largerValues = array.filter(function(i) {
    return smallerValues.indexOf(i) < 0;
  });
  return smallerValues.concat(largerValues);
}

console.log(splitByValue(5, [1, 3, 5, 7, 6, 4, 2]));

// Best Answer
function bestSplitByValue(k, elements){
  var array1 = [];
  var array2 = [];
...
console.log(bestSplitByValue(5, [1, 3, 5, 7, 6, 4, 2]));
